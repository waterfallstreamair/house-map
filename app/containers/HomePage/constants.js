...
export const TYPE_PROPERTIES_REQUEST = 'TYPE_COMMENTS_REQUEST';
export const TYPE_PROPERTIES_SUCCESS = 'TYPE_COMMENTS_SUCCESS';
export const TYPE_TEMPLATE_SET = 'TYPE_TEMPLATE_SET';
export const TYPE_FILTER_SET = 'TYPE_FILTER_SET';
